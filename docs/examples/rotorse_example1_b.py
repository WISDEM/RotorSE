...
rotor['sparT_in'] = np.array([1.44, 1.2125, 0.985, 0.7575, 0.53])  # (Array, m): spar cap thickness parameters
rotor['teT_in'] = np.array([0.8, 0.65, 0.5, 0.35, 0.2])  # (Array, m): trailing-edge thickness parameters
# ------------------
