--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
FAST v7.02 input file for turbine "WindPACT 0.75 MW" (J. Rinker, 03-Aug-16)
...
9999.9      TYCOn       - Time to enable active yaw control (s) [unused when YCMode=0]
  ...
  4188.29   VS_RtTq     - Rated generator torque/constant generator torque in Region 3 for simple variable-speed generator control (HSS side) (N-m) [used only when VSContrl=1]
  0.001292  VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1]
...
---------------------- INITIAL CONDITIONS --------------------------------------
  ...
  28.7      RotSpeed    - Initial or fixed rotor speed (rpm)
   0.0      NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
   0.0      TTDspFA     - Initial fore-aft tower-top displacement (meters)
   0.0      TTDspSS     - Initial side-to-side tower-top displacement (meters)
---------------------- TURBINE CONFIGURATION -----------------------------------
  25.000    TipRad      - The distance from the rotor apex to the blade tip (meters)
   1.250    HubRad      - The distance from the rotor apex to the blade root (meters)
  ...
  -2.33     OverHang    - Distance from yaw axis to rotor apex [3 blades] or teeter pin [2 blades] (meters)
  -0.0600   NacCMxn     - Downwind distance from the tower-top to the nacelle CM (meters)
   0.0      NacCMyn     - Lateral  distance from the tower-top to the nacelle CM (meters)
   1.2043   NacCMzn     - Vertical distance from the tower-top to the nacelle CM (meters)
  58.67     TowerHt     - Height of tower above ground level [onshore] or MSL [offshore] (meters)
   1.33     Twr2Shft    - Vertical distance from the tower-top to the rotor shaft (meters)
...
2.0950e+04  NacMass     - Nacelle mass (kg)
6.5739e+03  HubMass     - Hub mass (kg)
   ...
   0.0      TipMass(3)  - Tip-brake mass, blade 3 (kg) [unused for 2 blades]
      8623  NacYIner    - Nacelle inertia about yaw axis (kg m^2)
    16.651  GenIner     - Generator inertia about HSS (kg m^2)
...
"unused"    DynBrkFi    - File containing a mech-gen-torque vs HSS-speed curve for a dynamic brake [CURRENTLY IGNORED] (quoted string)
 1.3e+08    DTTorSpr    - Drivetrain torsional spring (N-m/rad)
 2.8e+05    DTTorDmp    - Drivetrain torsional damper (N-m/(rad/s))
...
"WP_0.75MW_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"WP_0.75MW_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"WP_0.75MW_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"WP_0.75MW_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"WP_0.75MW_AD.ipt"   	   ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
