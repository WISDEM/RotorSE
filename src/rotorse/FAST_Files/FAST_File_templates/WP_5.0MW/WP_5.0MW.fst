--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
FAST v7.02 input file for turbine "WindPACT 5.0 MW" (J. Rinker, 03-Aug-16)
...
9999.9      TYCOn       - Time to enable active yaw control (s) [unused when YCMode=0]
 ...
 27921.92   VS_RtTq     - Rated generator torque/constant generator torque in Region 3 for simple variable-speed generator control (HSS side) (N-m) [used only when VSContrl=1]
  0.008614  VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1]
...
---------------------- INITIAL CONDITIONS --------------------------------------
  ...
  11.2      RotSpeed    - Initial or fixed rotor speed (rpm)
...
---------------------- TURBINE CONFIGURATION -----------------------------------
  ...
  -0.3256   NacCMxn     - Downwind distance from the tower-top to the nacelle CM (meters)
   0.0      NacCMyn     - Lateral  distance from the tower-top to the nacelle CM (meters)
   2.3429   NacCMzn     - Vertical distance from the tower-top to the nacelle CM (meters)
 151.07     TowerHt     - Height of tower above ground level [onshore] or MSL [offshore] (meters)
   2.93     Twr2Shft    - Vertical distance from the tower-top to the rotor shaft (meters)
...
2.7067e+05  NacMass     - Nacelle mass (kg)
1.2597e+05  HubMass     - Hub mass (kg)
...
"WP_5.0MW_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"WP_5.0MW_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"WP_5.0MW_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"WP_5.0MW_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"WP_5.0MW_AD.ipt"       ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
