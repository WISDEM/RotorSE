...
class Airfoil(object):
    ...
    @classmethod
    def initFromCoordinateFile(cls, CoordinateFile, airfoil_analysis_options, polarType=Polar):
        ...
        # initialize
        polars = []
        afanalysis = AirfoilAnalysis(CoordinateFile, method='CoordinateFile')
    ...
    @classmethod
    def initFromNACA(cls, NACA, airfoil_analysis_options, polarType=Polar):
        """Construct Airfoil object from airfoil coordinate file
        ...
        # initialize
        polars = []
        afanalysis = AirfoilAnalysis(NACA, method='NACA')
        cl, cd, cm, alphas, failure = afanalysis.computeSpline(airfoil_analysis_options)
        Re = airfoil_analysis_options['Re']
        polars.append(polarType(Re, alphas, cl, cd, cm))
        return cls(polars)
    ...
    @classmethod
    def initFromThicknesses(cls, t_c, airfoil_analysis_options, polarType=Polar):
        """Construct Airfoil object from airfoil coordinate file
